...
export default function ARScanner() {
  ...
  return <div className="flex flex-col min-h-screen bg-black">
      ...
      <div className="flex-1 relative">
        ...
        {/* Scanner UI */}
        {scanState === 'scanning' && <div className="absolute inset-0 flex items-center justify-center">
        ...
        {scanState === 'loading' && <div className="absolute inset-0 flex items-center justify-center">
            <Loader size="lg" />
          </div>}
        {scanState === 'error' && <div className="absolute inset-0 flex items-center justify-center">
            <Card className="max-w-xs text-center">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-400 mb-4">
                  Unable to recognize object. Please try again.
                </p>
                <Button variant="primary" onClick={resetScan} icon={<div size={18} />}>
                  Try Again
                </Button>
              </div>
            </Card>
        ...
        <div className="absolute top-0 left-0 right-0 p-4 flex justify-between items-center">
          ...
          <Button variant="ghost" className="bg-black/40 backdrop-blur-sm rounded-full p-2" onClick={handleError}>
            <div size={20} />
          </Button>
        </div>
      ...
      {/* Results Overlay */}
      {showResults && <div className="absolute inset-x-0 bottom-0 p-4 animate-slide-up">
          <Card className="w-full">
            ...
            <p className="text-gray-400 mb-4">
              Mid-century modern design chair with ergonomic shape and premium
              materials.
            </p>
