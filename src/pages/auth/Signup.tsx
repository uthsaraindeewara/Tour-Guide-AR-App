      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <Card className="w-full max-w-sm mb-6">
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <InputField label="Confirm Password" type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} placeholder="Confirm your password" required error={confirmPassword && password !== confirmPassword ? 'Passwords do not match' : ''} />
            <Button variant="primary" fullWidth type="submit" disabled={isLoading || confirmPassword && password !== confirmPassword}>
        ...
        <p className="text-gray-400 text-sm">
          ...
          <Button variant="ghost" size="sm" onClick={() => navigate('/auth/login')} className="text-blue-500 p-0 hover:bg-transparent">
            Log in
          </Button>
        </p>
      </div>
